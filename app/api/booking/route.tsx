  ...
  try {
    ...
    const customerEmailHtml = `
      ...
      <html>
        <head>
          ...
          <title>Booking Request Received - Saudi Explorer</title>
        </head>
        <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; background-color: #f8f9fa;">
          <div style="background: linear-gradient(135deg, #f59e0b 0%, #ea580c 50%, #dc2626 100%); padding: 40px 20px; text-align: center; border-radius: 12px 12px 0 0;">
            <h1 style="color: white; margin: 0; font-size: 28px; font-weight: bold; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">🎉 Booking Request Received!</h1>
          ...
          <div style="background: white; padding: 40px 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <div style="background: #f9fafb; padding: 20px; border-radius: 8px; margin-bottom: 25px;">
              ...
              ${bookingData.insurance ? '<p style="margin: 8px 0;"><strong style="color: #374151;">Travel Insurance:</strong> ✅ Requested</p>' : ""}
            </div>
            ...
            <div style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%); padding: 20px; border-radius: 8px; border-left: 4px solid #3b82f6; margin-bottom: 25px;">
              ...
              <ul style="color: #1e40af; margin: 0; padding-left: 20px;">
                <li style="margin-bottom: 8px;">Our team will contact you within 24 hours with a personalized quote</li>
                <li style="margin-bottom: 8px;">We'll arrange payment options and send detailed itinerary</li>
    ...
    const companyEmailHtml = `
      ...
      <html>
        <head>
          <meta charset="utf-8">
          <title>New Booking Request - ${bookingReference}</title>
        </head>
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 20px; background: white;">
            ...
            <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; margin-top: 20px;">
              <p style="margin: 0; color: #1e40af;"><strong>Action Required:</strong> Contact customer within 24 hours with personalized quote and payment options.</p>
            </div>
          </div>
        </body>
      </html>
