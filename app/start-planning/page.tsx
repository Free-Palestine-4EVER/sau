...
export const metadata: Metadata = {
  ...
  description:
    "Plan your perfect trip to Saudi Arabia with our advanced trip planner. Select destinations, activities, accommodations, and get a personalized quote.",
}
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              activities, accommodations, and get a personalized quote for your dream vacation.
            </p>
          </div>
