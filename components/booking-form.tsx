...
import { CalendarIcon, Users, Phone, Mail, MapPin, Shield, Check } from "lucide-react"
                ...
                {selectedDate && (
                  <div className="mt-4 p-4 bg-gradient-to-r from-amber-50 via-orange-50 to-red-50 rounded-xl border border-amber-200 shadow-sm">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-amber-800 text-lg">Contact us for pricing</span>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="suite">Suite Upgrade</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 border-2 rounded-xl hover:border-amber-400 transition-all duration-300 shadow-sm hover:shadow-md">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Comprehensive coverage recommended</p>
                </div>
              ...
              <div className="bg-gradient-to-r from-amber-50 via-orange-50 to-red-50 p-6 rounded-xl border border-amber-200 shadow-sm">
                <div className="text-center">
                  <h4 className="font-bold text-lg text-amber-800 mb-2">Booking Summary</h4>
                  <p className="text-amber-700 mb-3 text-base leading-relaxed">
                    Our team will contact you within 24 hours with a personalized quote and payment options.
                  </p>
                  <p className="font-bold text-base text-amber-800">
                    Tour: {tourTitle} for {travelers} {travelers === 1 ? "traveler" : "travelers"}
                  </p>
                </div>
              </div>
              ...
              <p className="text-sm text-muted-foreground text-center leading-relaxed">
                By submitting, you agree to our terms and conditions. No payment required at this time.
              </p>
            </div>
          )}
        </form>
